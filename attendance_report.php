...
<div class="row">
    ...
    <div class="col-12">
        ...
        <a href="./download_employee_report.php?start=<?php echo $start ?>&end=<?php echo $end ?>" class="btn btn-info mb-2">Descargar reporte</a>
    </div>
    <div class="col-12">
        <div class="table-responsive">
            <table class="table">
                <thead>
                    <tr>
                        <th>Alumno</th>
                        <th>Cuenta de asistencias</th>
                        <th>Cuenta de ausencias </th>
                    </tr>
                </thead>
                <tbody>
